...
public class Technician {
	...
	public String toString() {
		return "Technician [technicianNo=" + technicianNo + ", technicianName=" + technicianName + ", contactNo="
				+ contactNo + ", emailAddress=" + emailAddress + ", experience=" + experience + ", designation="
				+ designation + ", serviceRequests=" + serviceRequests + "]";
	}
